...
('애플 기프트카드', FALSE, FALSE, FALSE, TRUE),
('구글 기프트카드', TRUE, FALSE, FALSE, FALSE),
('갤럭시 스토어 기프트카드', FALSE, TRUE, FALSE, FALSE),
('원 스토어 기프트카드', FALSE, FALSE, TRUE, FALSE);