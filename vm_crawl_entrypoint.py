"""headless 봇 차단 때문에 Cloud Run Job(headless)이 아니라 이 GCE VM
(Xvfb+headed)에서 돌아야 하는 5개 스크래퍼용 엔트리포인트.

대상: store_data.galaxy_store, voucher_data.zeropin/gmarket/naver_brandstore,
telecom_data.lgu_event_board (2026-08-19 진단: 이 5개만 headless Chromium을
...
RUNS = [
    ...
    ("voucher_data.run_all", ["zeropin", "gmarket", "naver_brandstore"], "Voucher_Benefit_Info_DB_vm.csv"),
