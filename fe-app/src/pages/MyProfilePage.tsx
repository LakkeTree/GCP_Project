...
export default function MyProfilePage() {
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen py-8 relative overflow-hidden">
            ...
            <section id="profile-section" ref={profileRef} className="bg-white rounded-lg border border-slate-200/90 p-6 md:p-8 shadow-xs space-y-6 scroll-mt-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center justify-between px-3.5 bg-slate-50 border border-slate-200 rounded-lg h-[58px]">
                    ...
                    <span className="text-[11px] font-bold text-emerald-600 bg-emerald-50 border border-emerald-200 px-2.5 py-1 rounded shrink-0">
                      ✓ 연동됨
                    </span>
                  </div>
                </div>
