...
export default function SupportedPaymentPage() {
  ...
  return (
    /* 💡 overflow-hidden 제거하여 스티키 스크롤 동작 복원 */
          ...
          <div className="lg:col-span-10 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {filtered.map((item) => (
                <div
                  key={item.id}
                  className="p-5 bg-white rounded-lg border border-slate-200/90 shadow-xs hover:border-[#00D2B8] hover:shadow-[0_4px_14px_rgba(0,210,184,0.25)] transition-all space-y-3 flex flex-col justify-between"
                >
